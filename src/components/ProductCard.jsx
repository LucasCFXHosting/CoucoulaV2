...
const ProductCard = ({ id, name, price,yearlyPrice, description, features, prename,link,isYearly }) => (

  <div key={id} className="flex flex-col items-center px-8 py-10 rounded-[20px] bg-white shadow-lg mb-8 mx-4">
    <h3 className={`${styles.heading3} font-bold text-center mb-4`}>{prename}</h3>
    <h3 className={`${styles.heading3} font-medium text-center mb-4`}>{name}</h3>
